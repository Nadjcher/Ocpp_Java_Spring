package com.evse.simulator.tnr;
...
public class TNRAspect {
    ...
    @Around("execution(* com.evse.simulator.websocket.OCPPWebSocketClient.sendOCPPMessage(..)) && args(sessionId, action, payload)")
    ...
    @Around("execution(* com.evse.simulator.websocket.OCPPWebSocketClient.startTransaction(..)) && args(sessionId, idTag)")
    ...
    @Around("execution(* com.evse.simulator.websocket.OCPPWebSocketClient.stopTransaction(..)) && args(sessionId)")
    ...
    @After("execution(* com.evse.simulator.websocket.SessionWebSocketHandler.afterConnectionEstablished(..)) && args(session)")
    public void afterConnect(WebSocketSession session) {
        recordSession(session, "connect");
    }

    @After("execution(* com.evse.simulator.websocket.SessionWebSocketHandler.afterConnectionClosed(..)) && args(session, ..)")
