...
function SessionCard({
  ...
  const onDisconnect = async () => {
    ...
    try {
      await j(`/api/sessions/${s.id}/voluntary-stop?reason=User%20requested%20disconnect`, { method: "POST" });
      console.log('[SimuEvseBoard] Session disconnected voluntarily:', s.id);
    } catch {
